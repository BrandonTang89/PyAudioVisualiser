...
max_height_percentile = 99.9        #Pecentile of amplitude that fills the entire height of screen Range = (0, 100]
...
f, t, Sxx = scipy.signal.spectrogram(music, sr,nperseg=2048)                                                #Sxx[frequency][time]
